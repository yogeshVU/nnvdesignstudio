"""
This script is called by the plugin-wrapper, LaunchNNV.js, which passes down the
...
from LaunchNNV import LaunchNNV
...
plugin = LaunchNNV(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
